    ...
    <Background.Wrapper>
      ...
      <Section.Wrapper>
        ...
        <FadeInSection>
          <Section.Content>
            <Section.Left>
              <Image.AboutMe src={require("./resources/AllisonandI.jpg")} />
            </Section.Left>
            <Section.Right>
        ...
        <FadeInSection>
          <Section.ContentReverse>
            ...
            <Section.Right>
              <Image.AWS src={require("./resources/aws.jpg")} />
            </Section.Right>
          </Section.ContentReverse>
        </FadeInSection>
        <FadeInSection>
          <Section.Content>
            <Section.Left>
              <Image.Fblite src={require("./resources/Fblite.jpg")} />
            </Section.Left>
            <Section.Right>
        ...
        <FadeInSection>
          <Section.ContentReverse>
            ...
            <Section.Right>
              <Image.Barklight src={require("./resources/Barklight.jpg")} />
            </Section.Right>
          </Section.ContentReverse>
        </FadeInSection>
        <FadeInSection>
          <Section.Content>
            <Section.Left>
              <Image.Myo src={require("./resources/Myo.jpg")} />
            </Section.Left>
            <Section.Right>
